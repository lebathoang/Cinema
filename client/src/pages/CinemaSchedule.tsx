              ...
              {movies.map((movie, mIdx) => (
                ...
                >
                  <div className="w-full md:w-40 aspect-[2/3] rounded-2xl overflow-hidden flex-shrink-0 border border-white/5">
                    <img src={movie.poster} alt={movie.title} className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-500" />
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between py-2">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                         ...
                         <span className="text-muted-foreground text-xs uppercase tracking-widest">{movie.genre.join(" • ")}</span>
                      </div>
